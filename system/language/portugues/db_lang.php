...
$lang['db_invalid_connection_str'] = 'Não é possível determinar as configurações do banco de dados com base na "connection string" que você enviou.';
...
$lang['db_invalid_query'] = 'TA consulta enviada não é válida.';
$lang['db_must_set_table'] = 'Você deve configurar a tabela do banco de dados para ser usada com sua consulta.';
$lang['db_must_set_database'] = 'Você deve definir o nome do banco de dados no arquivo de configuração do banco de dados.';
$lang['db_must_use_set'] = 'Você deve usar o método "set" para atualizar uma entrada.';
$lang['db_must_use_where'] = 'As atualizações não são permitidas a menos que elas contenham uma cláusula "where".';
...
$lang['db_transaction_failure'] = 'Falha na transação: Rollback executada.';
$lang['db_unable_to_drop'] = 'Não é possível deletar o banco de dados especificado.';
...
$lang['db_unable_to_set_charset'] = 'Não é possível definir a configuração de caracteres de conexão do cliente: %s';
